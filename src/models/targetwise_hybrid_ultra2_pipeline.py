...
OUTPUT_DIR = os.path.join(PROJECT_ROOT, "output", "submission_targetwise_hybrid_ultra2")

TA_BLEND_WEIGHT = 0.25
EC_BLEND_WEIGHT = 0.80
DRP_SPECIALIST_WEIGHT = 0.36
...
def run():
    ...
    with open(os.path.join(OUTPUT_DIR, "notes.txt"), "w", encoding="utf-8") as fh:
        ...
        fh.write("DRP final = 0.64 * chain_base + 0.36 * specialist(threshold=144).\n")
